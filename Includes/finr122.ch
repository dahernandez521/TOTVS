	...
	#define STR0008 " CÓDIGO DE CUENTA CORRIENTE:  "
	#define STR0009 " BANCARIAS "
	#define STR0010 "DEL REGISTRO O"
	#define STR0011 "  FECHA"
	#define STR0012 "MEDIO DE PAGO"
	...
	#define STR0017 "CODIGO UNICO DE"
	...
	#define STR0045 "CONTROL INTERNO"
	#define STR0046 "(TABLA 001)"
	#define STR0047 "LA OPERACION"
#else
	#ifdef ENGLISH
		...
		#define STR0008 "CHECKING ACCOUNT CODE:"
		#define STR0009 " BANK RELATED "
		#define STR0010 "OF RECORD OR"
		#define STR0011 "  DATE"
		...
		#define STR0045 "INTERNAL CONTROL"
		#define STR0046 "(TABLE 001)"
		#define STR0047 "THE OPERATION"
	#else
		...
		#define STR0008 If( cPaisLoc $ "ANG|PTG", " CÓDIGO DE CUENTA CORRIENTE:  ", "CÓDIGO DE CONTA CORRENTE:" )
		#define STR0009 If( cPaisLoc $ "ANG|PTG", " BANCÁRIAS ", " BANCARIAS " )
		#define STR0010 If( cPaisLoc $ "ANG|PTG", "DEL REGISTRO O", "DO REGISTRO OU" )
		#define STR0011 "  DATA"
		#define STR0012 If( cPaisLoc $ "ANG|PTG", "MEDIO DE PAGO", "MEIO DE PAGAMENTO" )
		...
		#define STR0017 If( cPaisLoc $ "ANG|PTG", "CODIGO UNICO DE", "CÓDIGO ÚNICO DE" )
		...
		#define STR0045 If( cPaisLoc $ "ANG|PTG", "CONTROL INTERNO", "CONTROLE INTERNO" )
		#define STR0046 If( cPaisLoc $ "ANG|PTG", "(TABLA 001)", "(TABELA 001)" )
		#define STR0047 If( cPaisLoc $ "ANG|PTG", "LA OPERACION", "A OPERAÇÃO" )
	#endif
#endif
