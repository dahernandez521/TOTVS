...
Function M486XMLHKA(cPrejixo, aFact, nPos, aError, lMailAut, lNoEnv, cFilSA, cFilAI0,cEmailEmp)
	...
	If oXML <> Nil	
		...
		If lDocSp .Or. lNotAjus //Documento Soporte - Notas de Ajuste (Crédito/Débito)
			dbSelectArea("SA2")
		...
		cDetTri := M486RESOBL(cCliProv, cLojProv, "T", lDocSp, lNotAjus)
		...
		If lDocSp .Or. lNotAjus 
			...
			If cTipoPer == "1" //Persona Jurídica	
				cRespCli := M486RESOBL(cCliProv, cLojProv, "R", lDocSp, lNotAjus)
...
@see (links_or_references)
/*/
Function M486RESOBL(cCliente, cLoja, cTipo, lDocSp, lNotAjus)
	Local cResp   := ""
