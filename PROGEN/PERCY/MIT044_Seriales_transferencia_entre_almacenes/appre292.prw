...
User Function STHWMS04()
	...
	//oDlg1 := TDialog():New(aSize[7]+100,100,aSize[6]-100,aSize[5]-100,"Seleccionar Proceso",,,,,,,,oMainWnd,.T.)

	oDlg1:lEscClose := .F. // Nao permite sair ao se pressionar a tecla ESC.

	oBrw1 := MsSelect():New( "TRX","TP_OK",,aCampos,.F.,@cMarca,{aSize[7],aPosObj[2,2],aPosObj[2,3],aPosObj[2,4]},,,oDlg1,,aCores)
