...
Endif
//Felipe se quita validacion para agregar reembolso
//If cLiqComp != "1"
	//cMsgDt += STR0014 + " = " + STR0017 + Chr(13) + Chr(10) 	//"Liquidación de compra" = //"1-Si "
//Endif
...
BEGIN TRANSACTION
	...
	//FELIPE , SE AGREGA VALIDACION PARA QUE SOLO HAGA EL PROCESO AL SER LIQUIDACION DE COMPRA
	If SE1->(MSSeek(cLlave) ) .AND. SF2->F2_TPVENT == '1' //Busca las cuentas por cobrar
		...
		If !lMsErroAuto
			...
			//AADD(aAlta,{'E2_HIST	', SF2->F2_XGLOSA           	, NIL})
